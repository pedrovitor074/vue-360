  ...
  methods: {
    ...
    setImage: function setImage() {
      ...
      if (!cached) {
        ...
        this.currentCanvasImage.onload = function () {
          var viewportElement = _this3.$refs.viewport.getBoundingClientRect();

          _this3.canvas.width = _this3.isFullScreen ? viewportElement.width : _this3.currentCanvasImage.width;
          _this3.canvas.height = _this3.isFullScreen ? viewportElement.height : _this3.currentCanvasImage.height;
    ...
    redraw: function redraw() {
      try {
        ...
        this.ctx.drawImage(this.currentCanvasImage, this.currentLeftPosition, this.currentTopPosition, this.currentCanvasImage.width, this.currentCanvasImage.height, centerShift_x, centerShift_y, this.currentCanvasImage.width * ratio, this.currentCanvasImage.height * ratio); // cria os marcadores de acordo com os dados que foram adicionar atraves de prop ou marcadores que foram recem criados
    ...
    hasHotSpotData: function hasHotSpotData() {
      var _this4 = this;

      if (this.hotSpot.length) {
        this.hotSpot.forEach(function (_ref) {
          var XPos = _ref.XPos,
              YPos = _ref.YPos,
              frame = _ref.frame,
              ID = _ref.ID,
    ...
    saveHotspot: function saveHotspot() {
    ...
    createHotSpot: function createHotSpot(mouse) {
      ...
      var mouseXPos = (mouse.clientX - rect.left) * scaleX;
    ...
    doDragging: function doDragging(evt) {
      ...
      if (this.dragStart) {
        ...
        this.ctx.translate(pt.x - this.dragStart.x, pt.y - this.dragStart.y); //redraw();
    ...
    trackTransforms: function trackTransforms(ctx) {
      ...
      return new Promise(function (resolve) {
        ...
        _this6.ctx.getTransform = function () {
          return xform;
        };
        ...
        _this6.ctx.save = function () {
          savedTransforms.push(xform.translate(0, 0));
          return save.call(_this6.ctx);
        };

        var restore = ctx.restore;

        _this6.ctx.restore = function () {
          xform = savedTransforms.pop();
          return restore.call(_this6.ctx);
        };

        var scale = _this6.ctx.scale;

        _this6.ctx.scale = function (sx, sy) {
          xform = xform.scaleNonUniform(sx, sy);
          return scale.call(_this6.ctx, sx, sy);
        };

        var rotate = _this6.ctx.rotate;

        _this6.ctx.rotate = function (radians) {
          xform = xform.rotate(radians * 180 / Math.PI);
          return rotate.call(_this6.ctx, radians);
        };

        var translate = _this6.ctx.translate;

        _this6.ctx.translate = function (dx, dy) {
          xform = xform.translate(dx, dy);
          return translate.call(_this6.ctx, dx, dy);
        };

        var transform = _this6.ctx.transform;

        _this6.ctx.transform = function (a, b, c, d, e, f) {
          ...
          return transform.call(_this6.ctx, a, b, c, d, e, f);
        };

        var setTransform = _this6.ctx.setTransform;

        _this6.ctx.setTransform = function (a, b, c, d, e, f) {
          xform.a = a;
          xform.b = b;
          xform.c = c;
          xform.d = d;
          xform.e = e;
          xform.f = f;
          return setTransform.call(_this6.ctx, a, b, c, d, e, f);
        };

        var pt = svg.createSVGPoint();

        _this6.ctx.transformedPoint = function (x, y) {
          pt.x = x;
          pt.y = y;
...
var __vue_render__ = function __vue_render__() {
  ...
  })])])]), _vm._v(" "), _vm.buttonsVerify ? _c('div', {
  ...
  })])])]) : _vm._e()], 2), _vm._v(" "), _vm._l(_vm.Hotspots, function (ht) {
    return _c('div', {
      key: ht.MarkID,
